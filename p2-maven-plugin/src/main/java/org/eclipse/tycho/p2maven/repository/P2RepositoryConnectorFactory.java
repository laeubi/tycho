	...
	public RepositoryConnector newInstance(RepositorySystemSession session, RemoteRepository repository)
		...
		if (P2ArtifactRepositoryLayout.ID.equals(repository.getContentType())) {
			...
			try {
				...
				IArtifactRepository artifactRepository = repositoryManager.loadRepository(uri, monitor);
				return new P2RepositoryConnector(repository, artifactRepository, session, repositoryLayout, monitor,
						log);
