...
public class MavenURLStreamHandlerProvider extends EquinoxLifecycleListener {
	...
	public void afterFrameworkStarted(EmbeddedEquinox framework) {
		...
		framework.registerService(URLStreamHandlerService.class,
				new MavenURLStreamHandler(context, repositorySystem, logger),
				properties);
	}

	private static final class MavenURLStreamHandler extends AbstractURLStreamHandlerService {
		...
		public MavenURLStreamHandler(LegacySupport context, RepositorySystem repositorySystem, Logger logger) {
