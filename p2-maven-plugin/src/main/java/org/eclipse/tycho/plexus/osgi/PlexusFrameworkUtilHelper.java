...
public class PlexusFrameworkUtilHelper implements FrameworkUtilHelper {
	...
	public Optional<Bundle> getBundle(Class<?> classFromBundle) {
		// TODO instead we might wrap the classloader?
		...
		if (factory != null) {
			...
			if (framework != null) {
				...
				// TODO it seems this is even called for the framework bundle...?
				// so we assume here if nothing is found it is the system bundle...
				return Optional.of(framework.getBundleContext().getBundle(0));
			}
		}
